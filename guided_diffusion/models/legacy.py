...
from .condition_net import GenericUNet
...
class UNetV1(nn.Module):
    ...
    def __init__(
        ...
        if high_way:
            features = 32
            self.hwm = GenericUNet(self.in_channels - 1, features, 1, 5, anchor_out=True)
